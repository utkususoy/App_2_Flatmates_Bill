from code.flat import Bill, Flatmate
from code.reports import PdfReport

amount = float(input("Hey user, enter the bill amount: "))
period = str(input("What is the bill period? E.g. December 2020: "))

name1 = str(input("What is your name? "))
days_in_house1 = int(input(f"How many days did {name1} stay in house during the bill period? "))

name2 = str(input("What is the name of the other flatmate? "))
days_in_house2 = int(input(f"How many days did {name2} stay in house during the bill period? "))
